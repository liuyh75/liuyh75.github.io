...
async function updateCalendar() {
    ...
    for (var i = 1; i <= daysInMonth; i++) {
        ...
        var dayIncome = await calculateDayIncome(dateStr);
...
// 计算某天的收益
async function calculateDayIncome(dateStr) {
...
async function getIncomeRecords() {
    try {
        ...
        localStorage.setItem('incomeRecords', JSON.stringify(formattedRecords));
